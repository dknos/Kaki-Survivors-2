...
const _kinkOffScratch = new Float32Array(SEGMENTS + 1);
const _kinkYScratch = new Float32Array(SEGMENTS + 1);
...
function _bakeSpine(slot, a, b, jitter, y, useSegments) {
  ...
  const kinkOff = _kinkOffScratch;
  const kinkY   = _kinkYScratch;
