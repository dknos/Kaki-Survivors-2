...
def main():
    ...
    s = bpy.context.scene
    # Blender 4.2 renamed the Eevee enum; keep the helper usable on both the
    # bundled 4.2 LTS binary and older local installs.
    engines = {item.identifier for item in s.render.bl_rna.properties['engine'].enum_items}
